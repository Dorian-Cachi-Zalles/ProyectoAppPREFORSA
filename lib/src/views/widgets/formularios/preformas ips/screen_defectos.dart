...
class DatosDEFIPS {
  ...
  DatosDEFIPS copyWith({
    int? id,
    bool? hasErrors,
    String? Hora, String? SeccionDefecto, int? DefectosEncontrados, String? Fase, bool? Palet, bool? Empaque, bool? Embalado, bool? Etiquetado, bool? Inocuidad, double? CantidadProductoRetenido, double? CanidadProductoCorregido, String? Observaciones
  }) {
    return DatosDEFIPS(
      id: id ?? this.id,
      ...
      CanidadProductoCorregido: CanidadProductoCorregido ?? this.CanidadProductoCorregido,
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return SwipeableTile.card(
                ...
                onSwiped: (_) => provider.removeDatito(context, dtdatosdefips.id!),
                ...
                child: GestureDetector(
                  ...
                  child: GradientExpandableCard(
                    ...
                    subtitle: 'Prueba',
                    expandedContent: [
                  ExpandableContent(label: 'Hora: ', stringValue: dtdatosdefips.Hora.toString()),
                  ExpandableContent(label: 'SeccionDefecto: ', stringValue: dtdatosdefips.SeccionDefecto.toString()),       
                  ExpandableContent(label: 'DefectosEncontrados: ', stringValue: dtdatosdefips.DefectosEncontrados.toString()),
                  ExpandableContent(label: 'Fase: ', stringValue: dtdatosdefips.Fase.toString()),
                  ExpandableContent(label: 'Palet: ', boolValue: dtdatosdefips.Palet),
                  ExpandableContent(label: 'Empaque: ', boolValue: dtdatosdefips.Empaque),
                  ExpandableContent(label: 'Embalado: ', boolValue: dtdatosdefips.Embalado),
                  ExpandableContent(label: 'Etiquetado: ', boolValue: dtdatosdefips.Etiquetado),
                  ExpandableContent(label: 'Inocuidad: ', boolValue: dtdatosdefips.Inocuidad),
                  ExpandableContent(label: 'CantidadProductoRetenido: ', stringValue: dtdatosdefips.CantidadProductoRetenido.toString()),
                  ExpandableContent(label: 'CanidadProductoCorregido: ', stringValue: dtdatosdefips.CanidadProductoCorregido.toString()),
                  ExpandableContent(label: 'Observaciones: ', stringValue: dtdatosdefips.Observaciones.toString()),
                    ],
      ...
      child:SizedBox(
            ...
            onPressed: () {
                ...
                hasErrors:_formKey.currentState?.fields.values.any((field) => field.hasError) ?? false,
                  ...
                  SeccionDefecto: values['SeccionDefecto'] ?? widget.datosDEFIPS.SeccionDefecto,
                  ...
                  CanidadProductoCorregido:(values['CanidadProductoCorregido']?.isEmpty ?? true)? 0 : double.tryParse(values['CanidadProductoCorregido']),
      ...
      child: Column(
        children: [
          ...
          FormBuilderDropdown<String>(
            ...
            decoration: InputDecoration(labelText: 'Secciondefecto',
            labelStyle: TextStyle(fontSize: 20,color: const Color.fromARGB(255, 20, 100, 96),fontWeight: FontWeight.bold),  
              filled: true,
              fillColor: Colors.grey[200], // Color de fondo de los campos
              border: OutlineInputBorder(
          ...
          FormBuilderTextField(
            ...
            onChanged: (value) {
            final field = _formKey.currentState?.fields['DefectosEncontrados'];
            field?.validate(); // Valida solo este campo
            field?.save();
          },
            decoration: InputDecoration(labelText: 'Defectosencontrados',
            labelStyle: TextStyle(fontSize: 20, color: const Color.fromARGB(255, 20, 100, 96),fontWeight: FontWeight.bold), 
              filled: true,
              fillColor: Colors.grey[200], // Color de fondo de los campos
              errorStyle: TextStyle(
              ...
              suffixIcon: Builder(
                builder: (context) {
                  final isValid = _formKey.currentState?.fields['DefectosEncontrados']?.isValid ?? false;
                  return Icon(
                    isValid ? Icons.check_circle : Icons.error,
                    color: isValid ? Colors.green : Colors.red,
                  );
          ...
          FormBuilderCheckbox(
            ...
            title: Text('Inocuidad'),
          ),

          const SizedBox(height: 15,),
          FormBuilderTextField(
            name: 'CantidadProductoRetenido',
            initialValue: widget.datosDEFIPS.CantidadProductoRetenido.toString(),
            onChanged: (value) {
            final field = _formKey.currentState?.fields['CantidadProductoRetenido'];
            field?.validate(); // Valida solo este campo
            field?.save();
          },
            decoration: InputDecoration(labelText: 'Cantidadproductoretenido',
            labelStyle: TextStyle(fontSize: 20, color: const Color.fromARGB(255, 20, 100, 96),fontWeight: FontWeight.bold), 
              filled: true,
              fillColor: Colors.grey[200], // Color de fondo de los campos
              errorStyle: TextStyle(
              ...
              suffixIcon: Builder(
                builder: (context) {
                  final isValid = _formKey.currentState?.fields['CantidadProductoRetenido']?.isValid ?? false;
                  return Icon(
                    isValid ? Icons.check_circle : Icons.error,
                    color: isValid ? Colors.green : Colors.red,
                  );
          ...
          FormBuilderTextField(
            ...
            initialValue: widget.datosDEFIPS.CanidadProductoCorregido.toString(),
            onChanged: (value) {
            final field = _formKey.currentState?.fields['CanidadProductoCorregido'];
            field?.validate(); // Valida solo este campo
            field?.save();
          },
            decoration: InputDecoration(labelText: 'Canidadproductocorregido',
            labelStyle: TextStyle(fontSize: 20, color: const Color.fromARGB(255, 20, 100, 96),fontWeight: FontWeight.bold), 
              filled: true,
              fillColor: Colors.grey[200], // Color de fondo de los campos
              errorStyle: TextStyle(
              ...
              suffixIcon: Builder(
                builder: (context) {
                  final isValid = _formKey.currentState?.fields['CanidadProductoCorregido']?.isValid ?? false;
                  return Icon(
                    isValid ? Icons.check_circle : Icons.error,
                    color: isValid ? Colors.green : Colors.red,
                  );
          ...
          FormBuilderTextField(
            ...
            labelStyle: TextStyle(fontSize: 20, color: const Color.fromARGB(255, 20, 100, 96),fontWeight: FontWeight.bold), 
              ...
              suffixIcon: Builder(
                builder: (context) {
                  final isValid = _formKey.currentState?.fields['Observaciones']?.isValid ?? false;
                  return Icon(
                    isValid ? Icons.check_circle : Icons.error,
                    color: isValid ? Colors.green : Colors.red,
                  );
