...
class DatosMPIPS {
  ...
  DatosMPIPS copyWith({
    int? id,
    bool? hasErrors,
    String? MateriaPrima, String? INTF, String? CantidadEmpaque, String? Identif, int? CantidadBolsones, double? Dosificacion, double? Humedad, bool? Conformidad
  }) {
    return DatosMPIPS(
      id: id ?? this.id,
              ...
              return SwipeableTile.card(
                ...
                child: GestureDetector(
                  ...
                  child: GradientExpandableCard(
                    ...
                    subtitle: 'Prueba',
                    expandedContent: [
                  ExpandableContent(label: 'MateriaPrima: ', stringValue: dtdatosmpips.MateriaPrima.toString()),
      ...
      child:SizedBox(
            ...
            onPressed: () {
                ...
                hasErrors:_formKey.currentState?.fields.values.any((field) => field.hasError) ?? false,
                  MateriaPrima: values['MateriaPrima'] ?? widget.datosMPIPS.MateriaPrima,
      ...
      child: Column(
        children: [
          ...
          FormBuilderDropdown<String>(
            ...
            decoration: InputDecoration(labelText: 'Materiaprima',
