...
class DatosTEMPIPSProvider with ChangeNotifier {
  ...
  List<DatosTEMPIPS> get datostempipsList =>
      List.unmodifiable(_datostempipsList);
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          action: SnackBarAction(
            ...
            onPressed: () async {
              final newId =
                  await _db.insert(tableDatosTEMPIPS, deletedData.toMap());
...
class ScreenListDatosTEMPIPS extends StatelessWidget {
  const ScreenListDatosTEMPIPS({super.key});
            ...
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return SwipeableTile.card(
                  ...
                  onSwiped: (_) =>
                      provider.removeDatito(context, dtdatostempips.id!),
                  ...
                  child: GestureDetector(
                    ...
                    child: GradientExpandableCard(
                      ...
                      expandedContent: [
                        ExpandableContent(
                            label: 'Hora: ',
                            stringValue: dtdatostempips.Hora.toString()),
                        ExpandableContent(
                            label: 'Fase: ',
                            stringValue: dtdatostempips.Fase.toString()),
                        ExpandableContent(
                            label: 'Cavidades: ',
                            intListValue: dtdatostempips.Cavidades),
                        ExpandableContent(
                            label: 'TempCuerpo: ',
                            doubleListValue: dtdatostempips.TempCuerpo),
                        ExpandableContent(
                            label: 'TempCuello: ',
                            doubleListValue: dtdatostempips.TempCuello),
                      ],
...
class EditDatosTEMPIPSForm extends StatefulWidget {
  ...
  const EditDatosTEMPIPSForm(
      {required this.id, required this.datosTEMPIPS, super.key});
                  ...
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () {
                      ...
                      final Cavidades = List.generate(
                        ...
                        (index) =>
                            int.tryParse(values['Cavidades_$index'] ?? '0') ??
                            0,
                      );
                      ...
                      final updatedDatito = widget.datosTEMPIPS.copyWith(
                        ...
                        Cavidades: Cavidades,
                        TempCuerpo: values['TempCuerpo'] ??
                            widget.datosTEMPIPS.TempCuerpo,
                        TempCuello: values['TempCuello'] ??
                            widget.datosTEMPIPS.TempCuello,
                      );
          ...
          ...List.generate(
            ...
            (index) => Padding(
              ...
              child: FormBuilderTextField(
                ...
                onChanged: (value) {
                  final field =
                      _formKey.currentState?.fields['Cavidades_$index'];
                  field?.validate(); // Valida solo este campo
                  field?.save();
                },
                autovalidateMode: AutovalidateMode.onUserInteraction,
                decoration: InputDecoration(
                  labelText: 'Cavidades ${index + 1}',
                  labelStyle: const TextStyle(
                      fontSize: 20,
                      color: Color.fromARGB(255, 20, 100, 96),
                      fontWeight: FontWeight.bold),
                  ...
                  suffixIcon: Builder(
                    builder: (context) {
                      final isValid = _formKey.currentState
                              ?.fields['Cavidades_$index']?.isValid ??
                          false;
                      return Icon(
                        isValid ? Icons.check_circle : Icons.error,
                        color: isValid ? Colors.green : Colors.red,
          ...
          ...List.generate(
            ...
            (index) => Padding(
              ...
              child: FormBuilderTextField(
                ...
                onChanged: (value) {
                  final field =
                      _formKey.currentState?.fields['TempCuerpo_$index'];
                  field?.validate(); // Valida solo este campo
                  field?.save();
                },
                autovalidateMode: AutovalidateMode.onUserInteraction,
                decoration: InputDecoration(
                  labelText: 'TempCuerpo ${index + 1}',
                  labelStyle: const TextStyle(
                      fontSize: 20,
                      color: Color.fromARGB(255, 20, 100, 96),
                      fontWeight: FontWeight.bold),
                  ...
                  suffixIcon: Builder(
                    builder: (context) {
                      final isValid = _formKey.currentState
                              ?.fields['TempCuerpo_$index']?.isValid ??
                          false;
                      return Icon(
                        isValid ? Icons.check_circle : Icons.error,
                        color: isValid ? Colors.green : Colors.red,
          ...
          ...List.generate(
            ...
            (index) => Padding(
              ...
              child: FormBuilderTextField(
                ...
                onChanged: (value) {
                  final field =
                      _formKey.currentState?.fields['TempCuello_$index'];
                  field?.validate(); // Valida solo este campo
                  field?.save();
                },
                autovalidateMode: AutovalidateMode.onUserInteraction,
                decoration: InputDecoration(
                  labelText: 'TempCuello ${index + 1}',
                  labelStyle: const TextStyle(
                      fontSize: 20,
                      color: Color.fromARGB(255, 20, 100, 96),
                      fontWeight: FontWeight.bold),
                  ...
                  suffixIcon: Builder(
                    builder: (context) {
                      final isValid = _formKey.currentState
                              ?.fields['TempCuello_$index']?.isValid ??
                          false;
                      return Icon(
                        isValid ? Icons.check_circle : Icons.error,
                        color: isValid ? Colors.green : Colors.red,
